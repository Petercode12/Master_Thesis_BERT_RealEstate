currentTimestamp = parseInt(moment().unix());
        ...
        function deleteDatatableRecords(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#dataNhaDat24h').DataTable().clear().draw();
                },
                error: (xhr) => {
                    const notyf = new Notyf({
                        position: {
        ...
        function NhaDat24hChangeToServerSide(){
            var table = $('#dataNhaDat24h').DataTable({
                ...
                scrollX: true,
                order: [[ 2, "desc" ]],
                sAjaxSource: "/nhadat24h-show-data/",  
                    columnDefs: [
                        // {
                        //     targets: 6,
                        //     visible: false
                    ...
                    columns: [
                        ...
                        {name: "id", data: 0},
                        {name: "post_title", data: 2},
                        {name: "type", data: 3},
                        {name: "description", data: 4},
                        {name: "area", data: 5},
                        {name: "bedroom", data: 6},
                        {name: "bathroom", data: 7},
                        {name: "floors", data: 8},
                        {name: "legal", data: 9},
                        {name: "price_with_unit", data: 10},
                        {name: "address", data: 11},
                        {name: "url", data: 12, 
                        ...
                        {name: "post_author", data: 13},
                        {name: "phone_number", data: 14}
            ...
            $('button.toggle-vis-nhadat24h').on( 'click', function (e) {
                    e.preventDefault();
    ...
    function crawlNhaDat24h(end_page){
