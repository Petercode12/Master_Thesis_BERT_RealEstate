currentTimestamp = parseInt(moment().unix());
        ...
        function deleteDatatableRecords(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#dataMuaBan').DataTable().clear().draw();
                },
                error: (xhr) => {
                    const notyf = new Notyf({
                        position: {
        ...
        function MuaBanChangeToServerSide(){
            var table = $('#dataMuaBan').DataTable({
                ...
                sAjaxSource: "/muaban-show-data/",  
                    ...
                    columns: [
                        ...
                        {name: "area", data: 6},
                        {name: "bedroom", data: 7},
                        {name: "bathroom", data: 8},
                        {name: "floors", data: 9},
                        {name: "legal", data: 10},
                        {name: "price_with_unit", data: 11},
                        {name: "address", data: 12},
                        {name: "coordinate", data: 13,
                    render: function(data, type){
                        ...
                        {name: "post_author", data: 15},
                        {name: "phone_number", data: 16}
